...
Version 0.1.17 pins the unmodified `@docviewkit/viewer@0.2.63` package as its only parser and renderer.
...
The browser smoke requires Chrome at `/Applications/Google Chrome.app/Contents/MacOS/Google Chrome`, or set `DOCVIEWKIT_CHROME`. Outputs are `vscode/docviewkit-omni-0.1.17.vsix` and `jetbrains/build/distributions/docviewkit-omni-0.1.17.zip`.
